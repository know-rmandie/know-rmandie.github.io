...
---
body:
*version future de la base de données avec les références à l'[ancienne structure de la base](./ancienne-base) et pour être en conformité avec le projet de [fiche étude](./fiche-etude)*
...
|| __*Programmation*__
priorite | un niveau de priorité pour la prestation | int | - | *-* | par exemple de 0 - indispensable (liste du directeur) à 5 - pas prêt (barême à définir)
