...
(function($) {
    $(function() {
        console.log("pGi launched!");
        /* CREATING STYLES */
        $("head").append("<style id='pgiStyle'></style>");
        // getting colors !todo
        // creating styles
        var pgiStyle = "#pGi {display:;position:absolute;top:0;left:0;z-index:42;width:100%;height:100%;background:rgba(255,255,255,0.7);}";
        ...
        var pgi_thanksHtml = "<div id='pgiThanks'><p>submission (should be) on its way. Be patient.</p></div>";
        ...
        $form.submit(function(evt) {
            ...
            $.post(pgiFormUrl, formData, function(data) {
               ...
               console.log('Response id: ' + data.iid);
                var newThanks=pGi.thanks+"<br/>Your issue has been posted and is awaiting. Keep an eye on it at <a href='https://" + pGi.gitlab + "/" + pGi.usgroup + "/" + pGi.project + "/issues/" + data.iid +"' target='_blank'>https://" + pGi.gitlab + "/" + pGi.usgroup + "/" + pGi.project + "/issues/" + data.iid +"</a>";
                // Thanks and feedback
