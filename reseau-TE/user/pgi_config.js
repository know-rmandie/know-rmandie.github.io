...
/* F I E L D S list*/
   form:[
       ...
       {name:"etiquette",type:"text",dest:"labels",def:"reseau-TE",req:false,hid:true},
   ...
   thanks:"Merci de nous aider à améliorer la cartographie du réseau Transition Energétique en Normandie.",
   autoclose:false
}
/* H E L P
// about integration
