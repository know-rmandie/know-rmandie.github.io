...
/* G I T L A B repo informations */
   ...
   project:"know-rmandie-gitlab-io",               // project id in gitlab - should not contain any dot (. nor "%2E")
...
/* F I E L D S list*/
   form:[
       ...
       {name:"sous-projet",type:"text",dest:"title",def:"foncier public : non-lektor",req:false,hid:true},
   ...
   intro:"envoyez vos remarques ou demandes d'amélioration pour cette carte.",
